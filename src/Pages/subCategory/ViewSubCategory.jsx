...
import columns from '../../Components/subCategory/ViewColumns';
import { data } from '../../Components/subCategory/ViewData';
import { dbe } from '../../Components/subCategory/ViewCatData';
    ...
    <div className='p-2'>
            <div className='p-3 lg:p-5'>
                <div className='flex justify-between items-center  mb-2'>
                    <h2 className='font-semibold text-lg'> View Sub Category</h2>
